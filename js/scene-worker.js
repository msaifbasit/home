/* ============================================================
   ...
   The heavy Three.js parse/compile and all rendering happen off
   the main thread, so page animations (typing, scrolling) never
   stutter while the scene boots. main.js transfers the canvas
   here as an OffscreenCanvas and forwards input events.
   ============================================================ */
